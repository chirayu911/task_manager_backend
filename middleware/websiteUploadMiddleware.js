...
const fileFilter = (req, file, cb) => {
  ...
  const allowedVideoTypes = /mp4|mkv|mov|avi|webm/;
  ...
  if (extname && mimetype) {
    ...
    cb(new Error('Invalid file type. Only images, videos, and SVGs are allowed!'), false);
  }
};
...
const websiteUpload = multer({
  storage: storage,
  limits: { 
    // Increased limit to 500MB to accommodate multiple high-quality videos
